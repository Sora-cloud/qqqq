                                                        ...
                                                        if ctx.author.id == interaction.user.id:
                                                            ...
                                                            if f"theme_{id_theme}" in self.user_themes:
                                                                ...
                                                                if globalself.db.get_balance_marry(ctx.author) >= cost:
                                                                        ...
                                                                        async def button_callback_yes(self, button, interaction: discord.Interaction):
                                                                            ...
                                                                            if ctx.author.id == interaction.user.id:
                                                                                if f"theme_{id_theme}" in self.user_themes:
                                                                                    ...
                                                                                    embed = discord.Embed(title=f'Магазин профилей', description=f"**Вы** успешно **купили** тему профиля **№{id_theme}** за **{globalself.cost_theme_default_lprofile}** :candy:\n\nНовая тема **установлена**", color=discord.Colour.green())
                                                                                    embed.set_image(url="https://cdn.discordapp.com/attachments/992883178362642453/1029462389130792970/-1.png")
                                                                                    embed.set_thumbnail(url=ctx.author.display_avatar.url)
                                                                    ...
                                                                    embed = discord.Embed(title=f'Магазин любовных профилей', description=f"**Вы** уверены что хотите **купить** тему профиля **№{id_theme}** за **{globalself.cost_theme_default_lprofile}** :candy:", color=0x2f3136)
                                                                    embed.set_image(url="https://cdn.discordapp.com/attachments/992883178362642453/1029462389130792970/-1.png")
                                                                    embed.set_thumbnail(url=ctx.author.display_avatar.url)
                                        ...
                                        class SettingsRoom(discord.ui.View):
                                            ...
                                            async def button_callback_name_room(self, button, interaction: discord.Interaction):
                                                ...
                                                if ctx.author.id == interaction.user.id:
                                                    ...
                                                    embed = discord.Embed(title="Название любовной комнаты", description=f"Вы уверены что хотите установить **{user_message.content}** новым названием вашей любовной комнаты, это будет стоить **{globalself.cost_room_change_name}** :candy:.\nЛучше посоветуйтесь с вашей второй половинкой.", color=0x2f3136)
                                                    embed.set_thumbnail(url=ctx.author.display_avatar.url)
                                                    embed.set_image(url="https://cdn.discordapp.com/attachments/992883178362642453/1029462389130792970/-1.png")
